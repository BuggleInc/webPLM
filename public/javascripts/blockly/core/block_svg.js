...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (steps, highlightSteps,
    ...
    for (var y = 0, row; row = inputRows[y]; y++) {
        ...
        if (this.block_.isCollapsed()) {
            ...
            for (var x = 0, input; input = row[x]; x++) {
                ...
                if (input.type == Blockly.INPUT_VALUE) {
                    ...
                    if (Blockly.RTL) {
                        ...
                        highlightInlineSteps.push('M', (cursorX - Blockly.BlockSvg.SEP_SPACE_X - 3 +
                        ...
                        highlightInlineSteps.push('M', (cursorX - Blockly.BlockSvg.SEP_SPACE_X + 1) + ',' +
                            (cursorY + Blockly.BlockSvg.INLINE_PADDING_Y + 1));
                        highlightInlineSteps.push('v', input.renderHeight + 1);
                        highlightInlineSteps.push('h', Blockly.BlockSvg.TAB_WIDTH - 2 -
                            input.renderWidth);
                        highlightInlineSteps.push('M', (cursorX - input.renderWidth - Blockly.BlockSvg.SEP_SPACE_X +
            ...
            if (Blockly.RTL) {
                highlightSteps.push('M', (cursorX - Blockly.BlockSvg.NOTCH_WIDTH +
                        Blockly.BlockSvg.DISTANCE_45_OUTSIDE) +
