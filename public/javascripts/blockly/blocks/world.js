Blockly.Blocks['world_ground_color'] = {
    init: function () {
        ...
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_GROUND_COLOR_TITLE);
...
Blockly.Blocks['world_baggle_ground'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_BAGGLE_GROUND_TITLE);
...
Blockly.Blocks['world_baggle_bag'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_BAGGLE_BAG_TITLE)
        this.setOutput(true, 'Boolean');
...
Blockly.Blocks['world_baggle_pickup'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_BAGGLE_PICKUP_TITLE);
...
Blockly.Blocks['world_baggle_drop'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_BAGGLE_DROP_TITLE);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
...
Blockly.Blocks['world_message_ground'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_MESSAGE_GROUND_TITLE);
        this.setOutput(true, 'Boolean');
...
Blockly.Blocks['world_message_write'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_MESSAGE_WRITE_TITLE);
...
Blockly.Blocks['world_message_read'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_MESSAGE_READ_TITLE);
...
Blockly.Blocks['world_message_clear'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_MESSAGE_CLEAR_TITLE);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
...
Blockly.Blocks['world_exitReached'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.WORLD_CROSSING_TITLE);
        this.setOutput(true, 'Boolean');
...
Blockly.Blocks['world_ground_white'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_GROUND_WHITE_TITLE);
        this.setOutput(true, 'Boolean');
        this.setTooltip(Blockly.Msg.WOLRD_GROUND_WHITE_TOOLTIP);
    }
};
...
Blockly.Blocks['world_ground_orange'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_GROUND_ORANGE_TITLE);
        this.setOutput(true, 'Boolean');
...
Blockly.Blocks['world_height_get'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_HEIGHT_GET_TITLE);
...
Blockly.Blocks['world_width_get'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_WIDTH_GET_TITLE);
        this.setOutput(true, 'Number');
...
Blockly.Blocks['world_indication_get'] = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput()
            .appendField(Blockly.Msg.WOLRD_INDICATION_GET_TITLE);
